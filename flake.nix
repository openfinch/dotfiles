...
{
  description = "Magi NixOS configuration";
  ...
  outputs = inputs @ { self, nixpkgs, nixpkgs-small, flake-utils, home-manager, ... }:
    ...
    in
    {
      ...
      nixosConfigurations = {
        caspar = nixpkgs.lib.nixosSystem {
          system = "x86_64-linux";
          modules = [ ./hosts/caspar ];
          specialArgs = { inherit inputs lib; };
        };

        # TODO: Bring other systems under Nix control
      };


      homeConfigurations = {
      #   caspar = home-manager.lib.homeManagerConfiguration (
      #     let
